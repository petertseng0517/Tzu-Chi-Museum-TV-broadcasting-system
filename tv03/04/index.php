...
if($pre<0 or $next>($limitpage_04+1)){
	session_destroy();
...
for ($i = 1; $i <= 3; $i++) {
  ...
  if($img_location_id>$category4_vedio_amount){
  ...
  <a href="player.php?vid=<?php echo $img_location_id; ?>"><img src="<?php echo "img/thumb/IMG" .$img_location_id .".png" ; ?>" id="<?php echo "IMG_" .$vedio_id ;?>"  width=" <?php echo $width_thumb; ?>"></a>
<?php 
}
echo "</p>";
