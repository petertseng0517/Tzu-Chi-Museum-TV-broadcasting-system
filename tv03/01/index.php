...
for ($i = 1; $i <= 3; $i++) {
  ...
  if($img_location_id>$category1_vedio_amount){
  ...
  <a href="player.php?vid=<?php echo $img_location_id; ?>"><img src="<?php echo "img/thumb/" .$img_location_id .".png" ; ?>" id="<?php echo "IMG_" .$vedio_id ;?>"  width=" <?php echo $width_thumb; ?>"></a>
<?php 
}
echo "</p>";
